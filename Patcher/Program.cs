...
namespace Patcher
{
	...
	public class Patcher
	{
		...
		{
            using (var baseModule = ModuleDefinition.ReadModule("TowerFall.exe", new ReaderParameters { ReadWrite = true }))
            {
                ...
                Func<MethodDefinition, string, MethodDefinition> cloneMethod = (modMethod, prefix) =>
                {
                    ...
                    {
                        var param = new GenericParameter(modMethod);
                ...
                baseModule.Write("TowerFallPatched.exe");
            }
		}
